      ...
      <v-card-text>
        <v-table>
          <template v-slot:default>
            ...
            <tbody>
              <tr
                v-for="tokens_on_blockchain in wallet.tokens_on_blockchains"
                :key="tokens_on_blockchain.id"
              >
                <td
                  v-if="
                    tokens_on_blockchain.token_on_blockchain.blockchain.explorer
                  "
                >
                  <a
                    :href="
                      tokens_on_blockchain.token_on_blockchain.blockchain
                ...
                <td>
                  {{ tokens_on_blockchain.token_on_blockchain.token.name }}
                </td>
                <td>
                  {{ calcBalance(tokens_on_blockchain) }}
                  {{ tokens_on_blockchain.token_on_blockchain.token.ticker }}

                  <div
                    v-if="tokens_on_blockchain.balance.manual"
                    class="tooltip"
                  >
                ...
                <td>
                  {{
                    tokens_on_blockchain.token_on_blockchain.token.last_price
                  }}$
                </td>
                <td>
                  {{
                    Number(
                      (
                        calcBalance(tokens_on_blockchain) *
                        tokens_on_blockchain.token_on_blockchain.token
                          .last_price
                      ).toFixed(2)
                    )
                  }}$
